...
import 'reklamacje_model.dart';
export 'reklamacje_model.dart';

class ReklamacjeWidget extends StatefulWidget {
  const ReklamacjeWidget({
    super.key,
    String? namepage,
  ...
  static String routeName = 'Reklamacje';
  static String routePath = '/reklamacje';

  @override
  State<ReklamacjeWidget> createState() => _ReklamacjeWidgetState();
}

class _ReklamacjeWidgetState extends State<ReklamacjeWidget> {
  late ReklamacjeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReklamacjeModel());
