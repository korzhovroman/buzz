...
class _ResetPasswordPageWidgetState extends State<ResetPasswordPageWidget>
  ...
  void initState() {
    ...
    _model.passwordNewRepetTextController ??= TextEditingController();
    _model.passwordNewRepetFocusNode ??= FocusNode();
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.passwordNewRepetTextController,
                                    focusNode: _model.passwordNewRepetFocusNode,
                                    autofocus: true,
                                    autofillHints: [AutofillHints.password],
                                    obscureText:
                                        !_model.passwordNewRepetVisibility,
                                    decoration: InputDecoration(
                                      labelText: 'Hasło',
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelLarge
                                  ...
                                  onPressed: () async {
                                    if (_model.passwordNewTextController.text ==
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          content: Text(
                                            'Hasła nie są takie same  lub zbyt słabe',
                                            style: TextStyle(
                                              color:
                                                  FlutterFlowTheme.of(context)
                                                      .primaryText,
