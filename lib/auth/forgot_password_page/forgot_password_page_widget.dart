...
class _ForgotPasswordPageWidgetState extends State<ForgotPasswordPageWidget>
  ...
  void initState() {
    ...
    _model.emailAddressRessetPasswordTextController ??= TextEditingController();
    _model.emailAddressRessetPasswordFocusNode ??= FocusNode();
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller: _model
                                        .emailAddressRessetPasswordTextController,
                                    focusNode: _model
                                        .emailAddressRessetPasswordFocusNode,
                                    autofocus: true,
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'Jeśli konto o podanym adresie e-mail istnieje, link do zresetowania hasła został wysłany.',
                                          style: TextStyle(
                                            color: FlutterFlowTheme.of(context)
                                                .primaryText,
