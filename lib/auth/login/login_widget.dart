                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.emailAddressLogTextController,
                                  focusNode: _model.emailAddressLogFocusNode,
                                  autofocus: true,
                            ...
                            Padding(
                              ...
                              child: Container(
                                width: double.infinity,
                                child: TextFormField(
                                  controller: _model.passwordLogTextController,
                                  focusNode: _model.passwordLogFocusNode,
                                  autofocus: true,
                                  autofillHints: [AutofillHints.password],
                                  obscureText: !_model.passwordLogVisibility,
                                  decoration: InputDecoration(
                                    labelText: 'Hasło',
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .labelLarge
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  final user =
                                    ...
                                    context,
                                    _model.emailAddressLogTextController.text,
                                  ...
                                  children: [
                                    ...
                                    TextSpan(
                                      ...
                                      recognizer: TapGestureRecognizer()
                                        ..onTap = () async {
                                          context
                                              .pushNamed(RegInWidget.routeName);
                                        },
                                    )
                                  ],
                                  style: FlutterFlowTheme.of(context)
