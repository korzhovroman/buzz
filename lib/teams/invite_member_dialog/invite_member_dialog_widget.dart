...
import 'invite_member_dialog_model.dart';
export 'invite_member_dialog_model.dart';

class InviteMemberDialogWidget extends StatefulWidget {
  const InviteMemberDialogWidget({super.key});
...
class _InviteMemberDialogWidgetState extends State<InviteMemberDialogWidget> {
  late InviteMemberDialogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InviteMemberDialogModel());
                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: ((_model.mailTextController.text == '') ||
                              ...
                              ? null
                              : () async {
                                  _model.apiResultINVAIT =
                                      await TeamConnectApiGroup
                                          .inviteTeamMemberCall
                                          .call(
                                    token: FFAppState().authToken,
                                    name: _model.enteredName,
                                    email: _model.enteredEmail,
                                  );

                                  if ((_model.apiResultINVAIT?.succeeded ??
                                      true)) {
                                    Navigator.pop(context);
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'Pracownik zaproszony',
                                          style: TextStyle(
