  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case EmployeePermissionsRow:
            return EmployeePermissionsRow(data);
          case AllegroAccountsRow:
            return AllegroAccountsRow(data);
          case MessageMetadataRow:
            return MessageMetadataRow(data);
          case AutoReplyLogRow:
            return AutoReplyLogRow(data);
          case TeamsRow:
            return TeamsRow(data);
          case TaskQueueRow:
            return TaskQueueRow(data);
          case UsersRow:
